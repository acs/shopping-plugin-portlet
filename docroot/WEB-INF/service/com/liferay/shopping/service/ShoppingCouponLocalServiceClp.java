...
public class ShoppingCouponLocalServiceClp implements ShoppingCouponLocalService {
	public ShoppingCouponLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		...
		_addShoppingCouponMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addShoppingCoupon",
				com.liferay.shopping.model.ShoppingCoupon.class);

		_createShoppingCouponMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
				"createShoppingCoupon", long.class);

		_deleteShoppingCouponMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteShoppingCoupon", long.class);

		_deleteShoppingCouponMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
		...
		_getShoppingCouponMethodKey8 = new MethodKey(_classLoaderProxy.getClassName(),
				"getShoppingCoupon", long.class);

		_getPersistedModelMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
				"getPersistedModel", java.io.Serializable.class);

		_getShoppingCouponsMethodKey10 = new MethodKey(_classLoaderProxy.getClassName(),
				"getShoppingCoupons", int.class, int.class);

		_getShoppingCouponsCountMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
				"getShoppingCouponsCount");

		_updateShoppingCouponMethodKey12 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateShoppingCoupon",
				com.liferay.shopping.model.ShoppingCoupon.class);

		_updateShoppingCouponMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateShoppingCoupon",
	...
	public java.util.List<com.liferay.shopping.model.ShoppingCoupon> getShoppingCoupons(
		...
		MethodHandler methodHandler = new MethodHandler(_getShoppingCouponsMethodKey10,
				start, end);
	...
	public int getShoppingCouponsCount()
		...
		MethodHandler methodHandler = new MethodHandler(_getShoppingCouponsCountMethodKey11);
	...
	public com.liferay.shopping.model.ShoppingCoupon updateShoppingCoupon(
		...
		MethodHandler methodHandler = new MethodHandler(_updateShoppingCouponMethodKey13,
				ClpSerializer.translateInput(shoppingCoupon), merge);
	...
	private MethodKey _addShoppingCouponMethodKey0;
	private MethodKey _createShoppingCouponMethodKey1;
	private MethodKey _deleteShoppingCouponMethodKey2;
	private MethodKey _deleteShoppingCouponMethodKey3;
	private MethodKey _dynamicQueryMethodKey4;
	private MethodKey _dynamicQueryMethodKey5;
	private MethodKey _dynamicQueryMethodKey6;
	private MethodKey _dynamicQueryCountMethodKey7;
	private MethodKey _getShoppingCouponMethodKey8;
	private MethodKey _getPersistedModelMethodKey9;
	private MethodKey _getShoppingCouponsMethodKey10;
	private MethodKey _getShoppingCouponsCountMethodKey11;
	private MethodKey _updateShoppingCouponMethodKey12;
